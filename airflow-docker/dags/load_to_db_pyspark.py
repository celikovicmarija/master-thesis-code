...
from utilities.pyspark_utils import load_data_pandas, clean_from_characters
...
def load_scraper_data_to_db(file: str = None):
    ...
    # oglasi_df = load_data(spark, f'data_preparation\\raw_data\\scraper\\processed\\{file}.csv')
    oglasi_df = load_data_pandas(spark, f'data_preparation\\raw_data\\scraper\\processed\\{file}.csv', sep=';',
                                 schema=halooglasi_schema)
