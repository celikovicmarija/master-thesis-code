# valid_api_key='daf0b7d902544f228256075d5827867e' celikovicmarija@gmail.com GEOCODING API
# valid_api_key='3ef9a85773f24dd9885d2ff1045cdf3a' fonis GEOCODING API
# 226b0dd9b80340f29d3a20c1d6cce023 trampa.i.marija gmail GEOCODING API
# d7274109d4a54447b568960c18d1ba90 alek.i.marija gmail GEOCODING API
# a34dd850c38342e28a527ce575d9eb2c master email
# 4caacf1cd57a4cc3926b01e4f77e835b zuehlke email
# 1b7cea6d91844011a55559d7f305285c osnovne studije mail
# 8bff78c56c724d14a3b7575df7962ce8 yahoo mail
import csv
...
def send_and_receive_geocoding(df_for_geocoding):
    counter = 0
    api_keys = [
        'd7274109d4a54447b568960c18d1ba90', 'a34dd850c38342e28a527ce575d9eb2c',
        '4caacf1cd57a4cc3926b01e4f77e835b', '1b7cea6d91844011a55559d7f305285c',
        '8bff78c56c724d14a3b7575df7962ce8', 'daf0b7d902544f228256075d5827867e', '3ef9a85773f24dd9885d2ff1045cdf3a',
        '226b0dd9b80340f29d3a20c1d6cce023']
    locations = []
...
def send_and_receive_place_api():
    counter = 0
    places = []
    api_keys = ['d7274109d4a54447b568960c18d1ba90',
                '4caacf1cd57a4cc3926b01e4f77e835b', '1b7cea6d91844011a55559d7f305285c',
                '8bff78c56c724d14a3b7575df7962ce8', 'daf0b7d902544f228256075d5827867e',
                '3ef9a85773f24dd9885d2ff1045cdf3a',
                '226b0dd9b80340f29d3a20c1d6cce023', 'a34dd850c38342e28a527ce575d9eb2c', ]
    valid_api_key = api_keys.pop()
    headers = CaseInsensitiveDict()
    headers["Accept"] = "application/json"
        ...
        try:
            with open('places.csv', 'a', encoding='utf-8', newline='') as f:
                ...
                for place_object in places:
                    ...
                    places_to_write.append(data)
                writer.writerows(places_to_write)
        except Exception as e:
            print(str(e))
...
def send_and_receive_place_details_api():
    ...
    api_keys = [
        ...
        '4caacf1cd57a4cc3926b01e4f77e835b', '1b7cea6d91844011a55559d7f305285c',
        '8bff78c56c724d14a3b7575df7962ce8', 'daf0b7d902544f228256075d5827867e',
        '3ef9a85773f24dd9885d2ff1045cdf3a', '226b0dd9b80340f29d3a20c1d6cce023']
    valid_api_key = api_keys.pop()
    headers = CaseInsensitiveDict()
    headers["Accept"] = "application/json"
        ...
        try:
            with open('place_details_more_details.csv', 'a', encoding='utf-8', newline='') as f:
                ...
                for place_details_obj in place_details:
                    ...
                    # place_details_to_write.append(data)
                    writer.writerow(data)
                # writer.writerows(place_details_to_write)
        except Exception as e:
            print(str(e))
